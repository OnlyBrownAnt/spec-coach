...
# ---- Run analyze ----
echo "--- Running spec-analyze ---"
analyze_output=$(run_claude_l2 "Use spec-analyze to cross-check the spec, plan, and tasks at specs/email-validator/. Report all inconsistencies you find." 120)
